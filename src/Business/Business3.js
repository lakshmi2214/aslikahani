...
function Business3(props) {
    ...
    return (
        <div className='row row-gap-4'>
            {props.dataObject?.locations?.BussGeneral.slice(8, 10).map((item, index) => {
                return (
        ...
        //     <div className='posts'>
        //         <div className='col-md-6'>
        //             {props.dataObject?.locations?.BussGeneral.slice(8, 9).map((item, index) => {
        ...
        //         <div className='col'>
        //             <div className='col-md-6'>
        //                 {props.dataObject?.locations?.BussGeneral.slice(9, 10).map((item, index) => {
