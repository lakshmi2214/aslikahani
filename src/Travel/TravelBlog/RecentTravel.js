                               ...
                               <div className="tab-pane active" id="popular" role="tabpanel">
                                  ...
                                  {data?.locations?.Recent.slice(0,1).map((item,index)=>{
                                     ...
                                     <li>
                                        ...
                                        <div className="caption" onClick={() => handleNavigation(item, index)}> <a href={process.env.REACT_APP_DOMAIN_NAME+'/travel/'+item.url}>{item.title}</a> </div>
                                     ...
                                     <li>
                                     {data?.locations?.Recent.slice(3,4).map((item,index)=>{
                                     console.log(item);
                                      return(
                                      <div key={index}> 
                                        <div className="pic" onClick={() => handleNavigation(item, index)}> 
