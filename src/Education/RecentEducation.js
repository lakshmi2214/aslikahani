...
function RecentEducation(props) {
               ...
               <div role="tabpanel">
                  ...
                  <div className="small-grid-container">
                     <ul className="small-grid">
                        <li>
                           {props.dataObject?.locations?.Popular.slice(2, 6).map((item, index) => {
                              console.log(item);
                              return (
                                 <div key={index}>
                                    <div className="small-post">
                                       ...
                                       <div className="post-content">
                                          <h3> <a href={process.env.REACT_APP_DOMAIN_NAME + '/education/' + item.url}>{item.title}</a> </h3>
