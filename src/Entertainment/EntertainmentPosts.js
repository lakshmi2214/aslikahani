...
function EntertainmentPosts(props) {
   ...
   return (
      <>
         <div className="row">
            <article className="col-md-6 col-sm-6 col-xs-12">
               <div className="grid-1">
                  {props.dataObject?.locations?.TrendingNews.slice(1,3).map((item, index) => {
                     console.log(item);
                     return (
                        <div key={index}>
                           ...
                           <div className="detail">
                              ...
                              <ul className="post-tools" onClick={() => handleNavigation(item, index)}>
                                 <li> by <a href={process.env.REACT_APP_DOMAIN_NAME + '/entertainment' + item.url}> <strong> {item.authored_by}</strong> </a></li>
                              </ul>
                           </div>
                        </div>
                     )
            ...
            <article className="col-md-6 col-sm-6 col-xs-12">
               <div className="grid-1">
                  {props.dataObject?.locations?.NationalNews.slice(1, 3).map((item, index) => {
                     console.log(item);
                     return (
                        <div key={index}>
                           <div className="picture">
         ...
         <div className="row">
            {/* <article className="col-md-6 col-sm-6 col-xs-12">
               <div className="grid-1">
                  {props.dataObject?.locations?.TopNews.slice(2, 3).map((item, index) => {
                     console.log(item);
                     return (
                        <div key={index}>
                           <div className="picture">
            ...
            <article className="col-md-6 col-sm-6 col-xs-12">
               <div className="grid-1">
                  {props.dataObject?.locations?.LatestPost.slice(3, 5).map((item, index) => {
                     console.log(item);
                     return (
                        <div key={index}>
                           <div className="picture">
