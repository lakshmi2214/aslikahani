...
function SidePopularEntertainment1(props) {
    ...
    <>
      <div className='col-md-12'>
        <div className='popular-side-cont'>
          ...
          {props.dataObject?.locations?.General.slice(1, 5).map((item, index) => {
            return (
      ...
      {/* {isMobile ? null : (
        <div className='col-md-12'>
          <div className='text-center' style={{ height: "35px", padding: "8px", marginBottom: "2%", backgroundColor: "#d32415", color: "white", cursor: "default" }}>POPULAR</div>
          {props.dataObject?.locations?.General.slice(1, 5).map((item, index) => {
            ...
            return (
              <div key={index}>
                <div className='col-md-12' style={{ padding: "0px" }}>
                  ...
                  <div className='col-md-8' style={{ padding: "4px" }}>
                    <div className='article-desc' style={{ padding: "5px" }}>
                      <h5 className='text-left' > <a href={process.env.REACT_APP_DOMAIN_NAME + '/' + item.category + '/' + item.url}>  {item.title}</a></h5>
                      <h5> {item.created_at}</h5>
                    </div>
...
export default SidePopularEntertainment1