...
function EditorsChoise(props) {
  ...
  return (
    <>
      ...
      <div className="col-md-12 mobile-view" style={{ paddingLeft: "8%", paddingRight: "8%" }}  >
                ...
                <div className="card" style={{ width: "20rem;", border: "1px solid #cfcbcb" }}>
                  <a href={process.env.REACT_APP_DOMAIN_NAME + '/' + item.category + '/' + item.url}>
                    <div className='img-hover-zoom'>
                      <img className="card-img-top" src={item.image} alt="imagecap" style={{ width: "-webkit-fill-available", height:"240px" }} />
                    </div> </a>
                  <div className="card-body">
                    ...
                    </div>{/* <p className="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p> */}
                  </div>
                </div><br />
              </div>
            </div>
