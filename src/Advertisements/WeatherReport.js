...
<div className="containers">
    <div className="weather-app flex">
        ...
        <div className="col-2 flex p-md">
            <div className="col-2 flex flex-col">
                <div>
                    <p className="col-sm text-dark">Current Weather</p>
                    <h2 id="townName" className="border-bottom">Location</h2>
                ...
                <div>
                    <h2 className="text-dark">
                        <span id="fahrenheit" className="toggle-unit">°F</span> | <span id="celsius" className="toggle-unit toggled">°C</span>
                    </h2>
                </div>
            </div>
            <div className="col flex flex-col">
                <div className="flex align-center d-inline-block m-auto">
                    <canvas id="icon" width="88" height="88"></canvas>
                </div>
                <div className="d-inline-block m-auto">
                    <p id="time" className="text-sm text-right text-dark border-bottom">00:00AM</p>
                    <h1 className="text-right d-block">
                        <span id="temp">0</span>°<span id="tempUnit" className="text-darker">C</span>
                    </h1>
                </div>
            </div>
        </div>
    </div>
    {/* <p className="copyright text-sm text-center text-darker">
        Coded by <a className="text-dark" href="https://codepen.io/jethazelhurst" target="_blank">Jethro Hazelhurst</a>
    </p> */}
</div>
